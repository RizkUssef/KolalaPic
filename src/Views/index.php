...
<section class="w-1/2  mx-auto dark:bg-dark-blur  bg-blur drop-shadow-main backdrop:blur-xl p-10 rounded-xl ">
    <div>
        <form action="http://localhost/KolalaPic/public/upload/uploadHandle" method="post" enctype="multipart/form-data">
            ...
            <input class="input dark:bg-primary" type="text" name="auther" id="" value="Ruk">

            <label class="text-2xl dark:text-bg text-primary" for="">Sub Category</label>
            <input class="input dark:bg-primary" type="text" name="subcategory" id="" value="ac mailn">

            <label class="text-2xl dark:text-bg text-primary" for="">Description</label>
            <textarea class="input dark:bg-primary" name="description" id="">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptates provident impedit iure ratione inventore nam consectetur incidunt totam veritatis nihil architecto explicabo eveniet, possimus aliquid magnam! Impedit molestiae pariatur corporis Voluptates provident impedit iure ratione inventore nam consectetur incidunt totam veritatis nihil architecto explicabo eveniet, possimus aliquid magnam! Impedit molestiae pariatur corporis consectetur adipisicing elit. Voluptates provident impedit iure ratione inventore nam consectetur incidunt totam veritatis nihil architecto explicabo eveniet, possimus aliquid magnam! Impedit molestiae pariatur corporis
            </textarea>
